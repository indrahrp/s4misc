...
def main():
    ...
    parser.add_argument('--list_ami',required=False,
                        help='--list_ami All ,  list AMI, default is All accounts')
...
def list_snapshot(subaccount='All',ami_snap=False):
        ...
        for account,sessinfo in Account_Session.SESS_DICT.items():
            ...
            if subaccount == 'All':
                ...
                for snapshot in resp:
                    if ami_snap:
                        if 'create_image' in snapshot.description:
