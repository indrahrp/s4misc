...
stack = core.Stack(app, "Proj-VONC-VISTA", env={'region': 'us-east-1','account':'921279086507'})
...
task_efs_volume_name='fsap-01ab2e9c5acd7c4e4'
...
efsvol=efs.FileSystem(stack,'VISTA_VONC_efsvolume',vpc=vpc,file_system_name='wes',security_group=security_group)
...
efs_access=core.CfnResource(stack, 'efs_access_point', type="AWS::EFS::AccessPoint",
                properties=dict( FileSystemId =  efsvol.file_system_id))


task_definition_vistaweb = ecs.FargateTaskDefinition(
    stack, "Proj-VONC_VISTA-task-vistaweb",
...
#task_child=task_definition_vistaweb.node.children.volumes
#print ("taks chhild",str(task_child))
#print("ecs_stage_chukd ",type(ecs_stage_child))
#ecs_stage_child.add_property_override("Name","newname")
#ecs_stage_child.add_property_override("Stages.4.Actions.0.Configuration.TaskDefinitionTemplateArtifact",synthesized_app_project.artifact_name)
...
task_definition_varsleuth = ecs.FargateTaskDefinition(
    stack, "Proj-VONC_VISTA-task-varsleuth",
    memory_limit_mib=8192,
    cpu=4096,
    family='Proj-VONC_VISTA-VarSleuth'
)
...
task_definition_voncweb = ecs.FargateTaskDefinition(
    stack, "Proj-VONC_VISTA-task-voncweb",
    memory_limit_mib=8192,
    cpu=4096,
    family='Proj-VONC-VISTA-Web'
)
...
task_definition_dispatcher = ecs.FargateTaskDefinition(
    stack, "Proj-VONC_VISTA-task-dispatcher",
    memory_limit_mib=8192,
    cpu=4096,
    family='Proj-VONC-VISTA-Dispatcher'
)
...
task_definition_spliceai = ecs.FargateTaskDefinition(
    stack, "Proj-VONC_VISTA-task-spliceai",
    memory_limit_mib=8192,
    cpu=4096,
    #volumes=[docker_volume],
    family='Proj-VONC_VISTA-Spliceai'
)
...
voncweb_container = task_definition_voncweb.add_container(
    "Proj-VONC_VISTA-vonc-container",
    image=ecs.ContainerImage.from_registry(ecr_repo_voncweb),
    essential=True,
    logging=ecs.LogDriver.aws_logs(stream_prefix="Proj-VONC_VISTA_vonc_logs"),
...
dispatcher_container = task_definition_dispatcher.add_container(
    "Proj-VONC_VISTA-dispatcher-container",
    image=ecs.ContainerImage.from_registry(ecr_repo_dispatcher),
    essential=True,
    logging=ecs.LogDriver.aws_logs(stream_prefix="Proj-VONC_VISTA_dispatcher_logs"),
    #stop_timeout=core.Duration.hours(8)
...
vistaweb_container = task_definition_vistaweb.add_container(
    "Proj-VONC_VISTA-vistaweb-container",
    ...
    logging=ecs.LogDriver.aws_logs(stream_prefix="Proj-VONC_VISTA_vista_logs"),
    #stop_timeout=core.Duration.hours(8)

)
efs_vol_to_mount=ecs.MountPoint(container_path='/efs',read_only=False,source_volume=task_efs_volume_name)
vistaweb_container.add_mount_points(efs_vol_to_mount)


#task_child=task_definition_vistaweb.node.children.volumes
#print ("taks chhild volume",str(task_child))


cont_child=task_definition_vistaweb.node.children[1]
#task_child_over=cont_child.add_override("Properties.Volumes.0", "proj_vonc_vista_efsvolume0")
#task_child_over=cont_child.add_override("Properties.Volumes.0.efsVolumeConfiguration.fileSystemId0",efsvol.file_system_id)
#task_child_over=cont_child.volumes=[{"name": 'task_efs_volume_name',"efsVolumeConfiguration":{"fileSystemId":efsvol.file_system_id}}]
task_child_over=cont_child.volumes=[{"name": task_efs_volume_name}]
task_child_over=cont_child.add_override("Properties.Volumes.0.efsVolumeConfiguration.fileSystemId",efsvol.file_system_id)
...
#task_child_over=cont_child.add_override("Properties.Volumes.0.efsVolumeConfiguration.fileSystemId0",efsvol.file_system_id)
#task_child_over=cont_child.add_override("Properties.Volumes.0.name", task_efs_volume_name)
#task_child_over=cont_child.add_override("Properties.Volumes.1.efsVolumeConfiguration.fileSystemId0",efsvol.file_system_id)
#task_child_over=cont_child.add_override("Properties.Volumes.1.name", task_efs_volume_name)
#task_child_over=cont_child.add_override("Properties.Volumes.0.authorizationConfig.accessPointId",efs_access )
#task_child_over=cont_child.add_override("Properties.Volumes.1.efsVolumeConfiguration.fileSystemId",efsvol.file_system_id)
#task_child_over=cont_child.add_override("Properties.Volumes.1.efsVolumeConfiguration.rootDirectory","/efs")
#task_child_over=cont_child.add_override("Properties.Volumes.0.name",)


print ("objec type ",dir(cont_child))
#method_list = [func for func in dir(cont_child) if callable(getattr(cont_child, func))]
#print ("cont chhild volume",str(method_list))
...
varsleuth_container = task_definition_varsleuth.add_container(
    "Proj-VONC_VISTA-varsleuth-container",
    image=ecs.ContainerImage.from_registry(ecr_repo_varsleuth),
    essential=True,
    logging=ecs.LogDriver.aws_logs(stream_prefix="Proj-VONC_VISTA_varsleuth_logs"),
    #stop_timeout=core.Duration.hours(8)
    #environment= {'HG19':'/var/www/html/mydo/hg19/ucsc.hg19.fasta','refSeqVer':'GRCH37','MYDO_DIR':'/var/www/html/mydo/LAGI','TMPDIR':'/tmp'}
...
spliceai_container = task_definition_spliceai.add_container(
    "Proj-VONC_VISTA-spliceai-container",
    image=ecs.ContainerImage.from_registry(ecr_repo_varsleuth),
    essential=True,
    logging=ecs.LogDriver.aws_logs(stream_prefix="Proj-VONC_VISTA_spliceai_logs"),
    #stop_timeout=core.Duration.hours(8)
    #environment= {'HG19':'/var/www/html/mydo/hg19/ucsc.hg19.fasta','refSeqVer':'GRCH37','MYDO_DIR':'/var/www/html/mydo/LAGI','TMPDIR':'/tmp'}
...
service_voncweb = ecs.FargateService(
    stack, "Proj-VONC_VISTA-ecs-service-voncweb",
    ...
    service_name='Proj-VONC_VISTA-Vonc'

)

service_dispatcher = ecs.FargateService(
    stack, "Proj-VONC_VISTA-ecs-service-dispatcher",
    platform_version=ecs.FargatePlatformVersion.VERSION1_4,
    cluster=cluster,
    ...
    desired_count=1,
    security_group=security_group,
    service_name='Proj-VONC_VISTA-Dispatcher'
)

service_vistaweb = ecs.FargateService(
    stack, "Proj-VONC_VISTA-ecs-service-vistaweb",
    cluster=cluster,
    platform_version=ecs.FargatePlatformVersion.VERSION1_4,
...
service_varsleuth = ecs.FargateService(
    ...
    desired_count=1,
    security_group=security_group,
    service_name='Proj-VONC_VISTA-VarSleuth'

)


service_spliceai = ecs.FargateService(
    stack, "Proj-VONC_VISTA-ecs-service-spliceai",
    cluster=cluster,
    platform_version=ecs.FargatePlatformVersion.VERSION1_4,
    ...
    desired_count=1,
    security_group=security_group,
    service_name='Proj-VONC_VISTA-SpliceAI'
...
lb_voncweb = elbv2.ApplicationLoadBalancer(
    stack, "Proj-VONC_VISTA_lb_voncweb",
    load_balancer_name='Proj-VONC-VISTA-Vonc-ELB',
    vpc=vpc,
    internet_facing=True
)

lb_dispatcher = elbv2.ApplicationLoadBalancer(
    stack, "Proj-VONC_VISTA_lb_dispatcher",
    load_balancer_name='Proj-VONC-VISTA--Dispatcher-ELB',
    vpc=vpc,
    internet_facing=True
)
...
lb_vista = elbv2.ApplicationLoadBalancer(
    stack, "Proj-VONC_VISTA_lb_vista",
    load_balancer_name='Proj-VONC-VISTA-Vista-ELB',
    vpc=vpc,
    internet_facing=True
)
...
lb_varsleuth = elbv2.ApplicationLoadBalancer(
    stack, "Proj-VONC_VISTA_lb_varleuth",
    vpc=vpc,
    load_balancer_name='Proj-VONC-VISTA-Varsleuth-ELB',
    internet_facing=True
)
...
lb_spliceai = elbv2.ApplicationLoadBalancer(
    stack, "Proj-VONC_VISTA_lb_spliceai",
    vpc=vpc,
    load_balancer_name='Proj-VONC-VISTA-SpliceAI-ELB',
    internet_facing=True
)
...
listener_voncweb.add_targets(
    "voncweb",
    target_group_name='Proj-VONC-VISTA-VoncWeb-Blue',
    port=443,
...
listener_dispatcher.add_targets(
    "dispatcher",
    target_group_name='Proj-VONC-VISTA-Dispatcher-Blue',
    port=3000,
...
listener_vista.add_targets(
    "vistaweb_target",
    target_group_name='Proj-VONC-VISTA-Vista-Blue',
    port=80,
...
listener_varsleuth.add_targets(
    "varsleuth_target",
    target_group_name='Proj-VONC-VISTA-Varsleuth-Blue',
    port=80,
...
listener_spliceai.add_targets(
    "spliceai_target",
    target_group_name='Proj-VONC-VISTA-SpliceAI-Blue',
    port=80,
...
voncweb_target_green=elbv2.ApplicationTargetGroup(stack,"voncweb_target_green",target_group_name='Proj-VONC-VISTA-VoncWeb-Green',port=443,target_type=elbv2.TargetType.IP,health_check=health_check,vpc=vpc)
listener_voncweb_green.add_target_groups("voncweb_green",target_groups=[voncweb_target_green])


dispatcher_target_green=elbv2.ApplicationTargetGroup(stack,"dispatcher_target_green",target_group_name='Proj-VONC-VISTA-Dispatcher-Green',port=3000,protocol=elbv2.ApplicationProtocol.HTTP,target_type=elbv2.TargetType.IP,health_check=dispatcher_health_check,vpc=vpc)
listener_dispatcher_green.add_target_groups("dispatcher_green",target_groups=[dispatcher_target_green])

vistaweb_target_green=elbv2.ApplicationTargetGroup(stack,"vistaweb_target_green",port=80,target_group_name='Proj-VONC-VISTA-Vista-Green',protocol=elbv2.ApplicationProtocol.HTTP,target_type=elbv2.TargetType.IP,health_check=health_check,vpc=vpc)
listener_vista_green.add_target_groups("vistaweb_green",target_groups=[vistaweb_target_green])


varsleuth_target_green=elbv2.ApplicationTargetGroup(stack,"varsleuth_target_green",port=80,target_group_name='Proj-VONC-VISTA-Varsleuth-Green',protocol=elbv2.ApplicationProtocol.HTTP,target_type=elbv2.TargetType.IP,health_check=health_check,vpc=vpc)
listener_varsleuth_green.add_target_groups("varsleuth_green",target_groups=[varsleuth_target_green])



spliceai_target_green=elbv2.ApplicationTargetGroup(stack,"spliceai_target_green",port=80,target_group_name='Proj-VONC-VISTA-SpliceAI-Green',protocol=elbv2.ApplicationProtocol.HTTP,target_type=elbv2.TargetType.IP,health_check=health_check,vpc=vpc)
...
core.CfnOutput(
    stack, "Proj-VONC_VISTA-LoadBalancerDNS_voncweb",
    value=lb_voncweb.load_balancer_dns_name
)

core.CfnOutput(
    stack, "Proj-VONC_VISTA-LoadBalancerDNS_dispatcher",
    value=lb_dispatcher.load_balancer_dns_name
)


core.CfnOutput(
    stack, "Proj-VONC_VISTA-LoadBalancerDNS_vista",
    value=lb_vista.load_balancer_dns_name
)

core.CfnOutput(
    stack, "Proj-VONC_VISTA=LoadBalancerDNS_varsleuth",
    value=lb_varsleuth.load_balancer_dns_name
)


core.CfnOutput(
    stack, "Proj-VONC_VISTA=LoadBalancerDNS_spliceai",
    value=lb_varsleuth.load_balancer_dns_name
)
