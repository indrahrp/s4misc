...
App_Name='VoncV-OncSuite-D'
s3_log_location='s4-voncv-hc-elb-logs'
app = core.App()
#stack = core.Stack(app, "onetest", env={'region': 'us-east-1','account':'417302553802'})
stack = core.Stack(app, App_Name, env={'region': 'us-east-1','account':'359051777659'})
s3_access_log=s3.Bucket.from_bucket_name(stack,"s3_access_log",s3_log_location)
...
ecr_repo_voncweb='359051777659.dkr.ecr.us-east-1.amazonaws.com/s4-vonc-dispatcher-placeholder-image:1'
ecr_repo_dispatcher="359051777659.dkr.ecr.us-east-1.amazonaws.com/s4-vonc-dispatcher-placeholder-image:1"
ecr_repo_vistaweb="359051777659.dkr.ecr.us-east-1.amazonaws.com/s4-varsleuth-vista-spliceai-placeholder-image:1"
ecr_repo_varsleuth="359051777659.dkr.ecr.us-east-1.amazonaws.com/s4-varsleuth-vista-spliceai-placeholder-image:1"
ecr_repo_spliceai="359051777659.dkr.ecr.us-east-1.amazonaws.com/s4-varsleuth-vista-spliceai-placeholder-image:1"
#ecr_repo_vistaweb=""
#spliceaiweb
#certificate_arn_sema4='arn:aws:acm:us-east-1:417302553802:certificate/b46a1c06-bc3b-4012-8f47-b2735ceccbc5'
certificate_arn_sema4='arn:aws:acm:us-east-1:359051777659:certificate/b2b814c7-1894-4acd-a06a-488a76859c5e'
app_security_group='sg-085ae755cbb671ebe'
...
tag=[core.CfnTag(key='FundNo',value='114'),core.CfnTag(key='Project',value='VoncV-HC-P')]


vpc=ec2.Vpc.from_vpc_attributes(stack,'vpcatt',availability_zones=['us-east-1a','us-east-1b'],vpc_id=core.Fn.import_value('SC-359051777659-pp-7ikqp27smgwvk-VpcID'),
                                private_subnet_ids=[core.Fn.import_value('SC-359051777659-pp-7ikqp27smgwvk-PrivateSubnet1ID'),core.Fn.import_value('SC-359051777659-pp-7ikqp27smgwvk-PrivateSubnet2ID')],
                                public_subnet_ids=[core.Fn.import_value('SC-359051777659-pp-7ikqp27smgwvk-PublicSubnet1ID'),core.Fn.import_value('SC-359051777659-pp-7ikqp27smgwvk-PublicSubnet2ID')])
...
#lb_voncweb.log_access_logs(s3_access_log,prefix=App_Name + '-Vonc-ELB')
...
#lb_dispatcher.log_access_logs(s3_access_log,App_Name + '-Dispatcher-ELB')
...
#lb_vista.log_access_logs(s3_access_log,App_Name + App_Name + '-Vista-ELB')
...
#lb_varsleuth.log_access_logs(s3_access_log,App_Name + "_lb_varleuth")
...
#lb_spliceai.log_access_logs(s3_access_log,App_Name + '-SpliceAI-ELB')
